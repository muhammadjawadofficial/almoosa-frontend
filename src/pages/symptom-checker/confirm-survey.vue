<template>
  ...
  >
    <div class="survey-flex">
      ...
      <div
        class="specialist-section block-section survey-flex"
    ...
    <div class="body-section">
      ...
      <div class="yesOrNo-container">
        <div
          class="yesOrNo"
          v-for="yesOrNo in confirmation"
          :key="'find-speciality-' + yesOrNo.id"
          @click="setSelectedyesOrNo(yesOrNo)"
          :class="{ active: yesOrNo.status }"
        >
