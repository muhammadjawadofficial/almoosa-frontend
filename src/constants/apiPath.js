...
export const apiPath = {
    ...
    appointment: {
        ...
        fetchTimeslots: (doctor, date, type, location_id) => getApiObject("get", "timeslots?doctor_id=" + doctor + (date ? "&dated=" + date : '') + (type ? "&type=" + type : '') + (location_id ? "&location_id=" + location_id : ''), "v2"),
